package Luminous.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import Luminous.cards.AbstractDefaultCard;

import static Luminous.DefaultMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "LuminousClass:" (or, your id) before the name.
    }
