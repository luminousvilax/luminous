...
public class PlaceholderPotion extends AbstractPotion {
    ...
    public static final String POTION_ID = Luminous.DefaultMod.makeID("PlaceholderPotion");
    ...
    public PlaceholderPotion() {
        // The bottle shape and inside is determined by potion size and color. The actual colors are the luckTestAction DefaultMod.java
